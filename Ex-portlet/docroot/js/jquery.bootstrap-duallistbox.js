  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.box1, .box2').removeClass('span6').addClass('span6');
        ...
        this.container.removeClass('row-fluid bs2compatible').addClass('row-fluid');
        this.container.find('.box1, .box2').removeClass('span6').addClass('span6');
        this.container.find('.clear1, .clear2').removeClass('btn-mini').addClass('btn-default btn-xs');
        this.container.find('input, select').addClass('form-control');
        this.container.find('.btn').addClass('btn-default');
        this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('icon-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('icon-arrow-left');
      }
      if (refresh) {
        refreshSelects(this);
      }
